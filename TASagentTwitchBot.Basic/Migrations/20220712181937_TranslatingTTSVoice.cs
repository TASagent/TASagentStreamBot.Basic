...
{
    public partial class TranslatingTTSVoice : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            //Set each legacy voice
            for (LegacyTTSVoice legacyVoice = 0; legacyVoice < LegacyTTSVoice.MAX; legacyVoice++)
            {
                migrationBuilder.UpdateData(
                    table: "Users",
                    keyColumn: "OldTTSVoicePreference",
                    keyValue: (int)legacyVoice,
                    column: "TTSVoicePreference",
                    value: Serialize(legacyVoice));
            }
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            for (LegacyTTSVoice legacyVoice = 0; legacyVoice < LegacyTTSVoice.MAX; legacyVoice++)
            {
                migrationBuilder.UpdateData(
                    table: "Users",
                    keyColumn: "TTSVoicePreference",
                    keyValue: Serialize(legacyVoice),
                    column: "OldTTSVoicePreference",
                    value: (int)legacyVoice);
            }
            ...
            migrationBuilder.RenameColumn(
                ...
                table: "Users",
                newName: "TTSVoicePreference");
        }

        private enum LegacyTTSVoice
        {
            Unassigned = 0,
        ...
        private static string Serialize(LegacyTTSVoice voice)
        {
            switch (voice)
            {
                case LegacyTTSVoice.Unassigned: return "";
                ...
                default:
                    ...
                    goto case LegacyTTSVoice.Unassigned;
            }
        }
    }
}
